...
# Subida de archivo
st.error("Sube tu archivo (.xls, .xlsx). Nota: el tamaño máximo es 20 MB, no 200 MB" if idioma == "Español" else "Upload your file (.xls, .xlsx). Note: the maximum file size is 20 MB, not 200 MB")
